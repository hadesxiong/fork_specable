  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden="true"
      />
      <div className="relative w-[500px] max-w-[90vw] bg-zinc-800 rounded-lg shadow-2xl border border-zinc-700 overflow-hidden">
        <input
          ref={inputRef}
          type="text"
          value={query}
                ...
                <div className="flex items-center gap-3">
                  <span
                    className={`text-xs uppercase w-16 ${
                      index === selectedIndex ? 'text-white/70' : 'text-zinc-600'
                    }`}
                    aria-hidden="true"
                  >
                    {cmd.category}
